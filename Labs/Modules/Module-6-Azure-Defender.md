...
2.	On the **Azure Portal** top search bar search for **Security Center** and click to open, then select **Security alerts** under **General** or by using this [link](https://portal.azure.com/?feature.argsecurityalerts=true&feature.customportal=false#blade/Microsoft_Azure_Security/SecurityMenuBlade/7)
...
1.	On the **Azure Portal** top search bar search for **Security Center** and click to open, then select **Security alerts** under **General**.
