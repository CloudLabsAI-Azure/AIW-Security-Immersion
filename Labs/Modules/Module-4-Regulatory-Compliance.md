...
2.	Type **Security Center** in the search box located on the top of the **Azure Portal** page and click on it. Next, from the overview page select **Regulatory Compliance** tile (this pilar is also available from the left sidebar under Cloud Security section).
...
2.	From the left pane of **Policy** page, select **Definitions**.
